...
from characters import spawnBarbarian, move_barbarians, spawnArcher, spawnStealthArcher, move_archers, move_stealth_archers, spawnDragon, move_dragons, spawnBalloon, move_balloons, spawnHealer, move_healers, clearTroops
...
while(True):
    ...
    move_stealth_archers(V,pt.movement)
    move_dragons(V)
    move_balloons(V)
    move_healers()
