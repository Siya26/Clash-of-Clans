...
def stealth_archColor(stealth_arch):
    health = stealth_arch.health
    max_health = stealth_arch.max_health
    percentage = (health*100)/max_health
    if(percentage > 50):
...
def printMap(V):
    ...
    for stealth_arch in stealth_archers:
        a= 2*stealth_arch.position[0]
        b = 2*stealth_arch.position[1]
        if stealth_arch.init_time + 10 < time.time():
            map_matrix[a][b] = stealth_archColor(stealth_arch) + Fore.BLACK + 'S  '
            map_matrix[a+1][b] = stealth_archColor(stealth_arch) + Fore.BLACK + 'AR'
            map_matrix[a][b+1] = stealth_archColor(stealth_arch) + Fore.BLACK + ' '
            map_matrix[a+1][b+1] = stealth_archColor(stealth_arch) + Fore.BLACK + 'CH'
    ...
    for hel in healers:
        a= 2*hel.position[0]
        b = 2*hel.position[1]
        map_matrix[a][b] = helColor(hel) + Fore.BLACK + 'HE '
        map_matrix[a+1][b] = helColor(hel) + Fore.BLACK + 'AL'
        map_matrix[a][b+1] = helColor(hel) + Fore.BLACK + ' '
        map_matrix[a+1][b+1] = helColor(hel) + Fore.BLACK + 'ER'
